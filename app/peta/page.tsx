...
const ZoneMap = dynamic(() => import("@/components/map/zone-map"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full min-h-[550px] lg:min-h-[650px] bg-slate-100 rounded-3xl flex flex-col items-center justify-center space-y-3 text-slate-400 animate-pulse border border-slate-200">
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-gradient-to-b from-sky-900 via-sky-800 to-slate-900 text-white py-16 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-4">
          ...
          >
            Navigasi Kawasan & Zonasi
          </Badge>
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight">
            Peta Interaktif Owabong Waterpark
          </h1>
          <p className="text-slate-200 text-base sm:text-lg max-w-2xl mx-auto">
            Jelajahi denah zonasi seluas puluhan hektar, temukan lokasi wahana air,
            sirkuit gokart, pusat kuliner, dan titik kumpul rombongan secara akurat.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            {/* Quick Tips */}
            <div className="p-4 rounded-2xl bg-white border border-slate-200 text-xs text-slate-600 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-xs">
              <div className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-emerald-600 shrink-0" />
                <span>Pos Penyelamat & P3K tersedia di setiap zona kolam utama.</span>
              </div>
              <Link
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Pilih zona untuk memusatkan peta
                  </p>
                </div>
              ...
              {selectedZone && (
                <div className="pt-4 border-t border-slate-100 space-y-4">
                  ...
                  <Link href="/reservasi" className="block pt-2">
                    <Button variant="accent" className="w-full font-bold justify-center gap-2 rounded-xl">
